#!/usr/bin/python
#
# comp_cov_dense.py computes the covariance matrices for each mode of an input tensor in dense representation for Dynamic Tensor Decomposition (DTA: Dynamic Tensor Analysis), which is used to incrementally update the tensor decomposition.
#
# Parameters
...
#
# Examples
#  comp_cov_dense.py tensor1 1000,1000,1000 100,100,100
#
...
#
#  comp_cov_dense.py tensor2 1000,1000,1000 100,100,100 tensor1
#
...
def main():
	argcnt = len(sys.argv)
	if argcnt < 4:
		print "comp_cov_dense.py <tensor_name> <tensor_size> <chunk_size> <old_tensor_name> <debug>"
		exit(2)
