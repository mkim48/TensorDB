...
class PhysicalHadamard : public  PhysicalOperator
{
public:
    PhysicalHadamard(std::string const& logicalName,
	...
	{
        return boost::shared_ptr<Array>(new HadamardArray(_schema, inputArrays[0], inputArrays[1], query));
	}
};

DECLARE_PHYSICAL_OPERATOR_FACTORY(PhysicalHadamard, "hadamard", "PhysicalHadamard")
