...
class PhysicalMaxNormArray : public  PhysicalOperator
{
public:
    PhysicalMaxNormArray(std::string const& logicalName,
...
DECLARE_PHYSICAL_OPERATOR_FACTORY(PhysicalMaxNormArray, "maxNormArray", "PhysicalMaxNormArray")
