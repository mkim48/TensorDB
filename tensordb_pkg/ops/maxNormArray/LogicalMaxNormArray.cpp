...
/**
 * @brief The operator: maxNormArray().
 *
 * @par Synopsis:
 *   maxNorm( array )
 *
 * @par Summary:
 *   Normalize array by max-norm
 */
class LogicalMaxNormArray : public  LogicalOperator
{
public:
	LogicalMaxNormArray(const std::string& logicalName, const std::string& alias):
...
DECLARE_LOGICAL_OPERATOR_FACTORY(LogicalMaxNormArray, "maxNormArray")
