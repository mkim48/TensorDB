...
class PhysicalTwoNormArray : public  PhysicalOperator
{
public:
    PhysicalTwoNormArray(std::string const& logicalName,
...
DECLARE_PHYSICAL_OPERATOR_FACTORY(PhysicalTwoNormArray, "twoNormArray", "PhysicalTwoNormArray")
